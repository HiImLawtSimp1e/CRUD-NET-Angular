...
namespace SuperHero_API.Controllers
{
    ...
    public class SuperHeroController : ControllerBase
    {
        ...
        {
            var response = await _context.SuperHeroes.ToListAsync();
            return Ok(response);
        }
        [HttpPost]
        ...
        {
            var dbHero = await _context.SuperHeroes.FirstOrDefaultAsync(x => x.Id == hero.Id);
            if (dbHero == null)
